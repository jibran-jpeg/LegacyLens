    ...
    <div style={{
      ...
      <div className="animate-scale" style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <h1 style={{ fontSize: 24, fontWeight: 700, letterSpacing: '-0.03em', marginBottom: 6 }}>Welcome back</h1>
          <p style={{ fontSize: 15, color: '#98989d' }}>Sign in to LegacyLens</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: 16 }}>
            <label style={{ display: 'block', fontSize: 13, fontWeight: 500, color: '#98989d', marginBottom: 6 }}>Email</label>
            <input
          ...
          <div style={{ marginBottom: 28 }}>
            <label style={{ display: 'block', fontSize: 13, fontWeight: 500, color: '#98989d', marginBottom: 6 }}>Password</label>
            <input
        ...
        <p style={{ textAlign: 'center', marginTop: 24, fontSize: 14, color: '#636366' }}>
          ...
          <Link to="/register" style={{ color: '#0a84ff', fontWeight: 500 }}>Create one</Link>
        </p>
      </div>
    </div>
  );
